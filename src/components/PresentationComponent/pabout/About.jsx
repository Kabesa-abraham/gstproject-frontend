  ...
  return (
    <section className='w-full min-h-screen flex items-center py-5 ' id='apropo' >
      <div className='max-w-7xl mx-auto px-3 md:px-10 flex flex-col md:flex-row justify-between gap-10 ' >
        ...
        <div className='flex flex-col gap-5 text-sm sm:text-lg lg:text-xl' >
          ...
          <button className='bg-[#4473ca] py-2 rounded-full text-white hover:ring-4 ring-blue-100 duration-200 text-sm md:text-lg font-semibold ' >Voir Plus</button>
        </div>
      </div>
    </section>
  )
